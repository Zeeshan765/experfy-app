  ...
  return (
    <div>
      ...
      <DialogTitle >
        ...
        >
          <p onClick={handleClose} style={{cursor:'pointer',margin:'0px',}}>
            <ArrowBackIosIcon />
            Back to page</p>
          <p onClick={handleClose} style={{cursor:'pointer',margin:'0px',}}>X</p>
        </div>
      </DialogTitle>
        {/* <Modal slug="my-modal" > */}
        <div key={id} style={{ width: "60%", margin: "auto" }}>
          <img
            src={image}
            style={{ width: "100%", objectFit: "contain", boxShadow: "1px 1px 3px 0px #000",marginBottom:'16px',borderRadius:'8px'}}
            alt={name}
          />
        </div>
      </Dialog>
