...
import Experfy, { RequiredPluginOptions } from '../ExperfyPlugin';
...
import { getStyles, practiceStyle, video } from '../ExperfyPlugin/blocks/style';
...
const SectionTemplatesBuilder: React.FC = () => {
  ...
  return (
    <div className='main__content main__content__editor'>
      <Eyebrow />
      {/* <button onClick={saveSectionTemplate}>saveSectionTemplate</button> */}
...
export default SectionTemplatesBuilder;
