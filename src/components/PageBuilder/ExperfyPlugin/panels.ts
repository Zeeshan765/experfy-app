...
export default (editor: GrapesJS.Editor, opts: RequiredPluginOptions) => {
	...
	const openBl = Panels.getButton('panel__switcher', openBlocks);
	...
	Panels.getPanels().reset([
		...
		//       visible: false,
		//       command: () => editor.runCommand(preview, undefined),
		...
		//       active: false,
		//       visible: false,
		//       command: () => editor.runCommand(exportTemplate, undefined),
		//       label: `<svg ${iconStyle} viewBox="0 0 24 24">
		...
		//       active: false,
		//       visible: false,
		//       command: () => editor.runCommand(clear, undefined),
		//       label: `<svg ${iconStyle} viewBox="0 0 24 24">
...
function getStyleEl(editor: any, panel = '.styles-container') {
	const row = editor.getContainer().closest('.editor-row');
