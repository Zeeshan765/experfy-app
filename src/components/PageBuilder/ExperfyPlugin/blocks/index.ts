  ...
  addBlock('benefits', {
   ...
   <div  sect="benefitSector" sectid="benefits-container" style="width: 70%;margin-left: 10rem; text-align: center; padding:25px;" >
      ...
      <div sect="benefitSector" style="text-align: center;">
         <h1 sect="benefitSector" sectid="main-benefit-headin" style="margin-bottom: 0.5rem;">Add your heading title here</h1>
         <h2 sect="benefitSector" sectid="sub-benefit-heading">The benefits module highlights the positive characteristics and values within your
 ...
 `,
  ...
  <div sect="guidelineSector"  sectid="guideline-container" style="width: 70%;margin: auto;padding: 6rem margin-left: auto;margin-right: auto; text-align: center;">
    <div sect= "guidelineSector" style="text-align: center;">
      ...
      <h2 sect= "guidelineSector"  sectid="sub-guideline-heading">The guideline module allows you to give directions or lead users to use a product,
...
`,
 ...
 <div style="display: flex;margin: 2rem 1rem;padding: 4rem 4rem; align-items: center;" sectid="main_container" sect="ImageTextSector">
  ...
  addBlock('search', {
    ...
    content: `<section style="width: 80%;margin:20px auto;">
    <div style="padding: 30px 50px;border-radius: 5px;background-color: #78C493;">
    <div style=" width: 70%;margin: auto;display: flex;position: relative;">
    <input type="text" style="width: 100%;border: none;outline: none;font-size: 16px;padding: 15px 10px;border-radius: 5px 0px 0px 5px;background-color: #FFFFFF;" placeholder="Search Item...">
    <button style="outline: none;color :#ffffff;cursor: pointer;font-size: 16px;padding: 15px 20px;text-align: center;border-radius:0px 5px 5px 0px;border:1px solid #48A3D7;background-color: #48A3D7;"> Search</button>
 </div>
    </div>
    </section>
    ${SearchStyle}
  ...
  addBlock('divider', {
    ...
    content: `
    <section  sect="dividerSector">
    <hr  sect ="dividerSector" sectid="divider-1">
    </section>
  ...
  addBlock('page-title', {
    ...
    content: `  <div  sect="pageSector">
    <h1 sect="pageSector" sectid="title-sector">page Builder Header #1234</h1>
</div>
        `,
  });
  addBlock('icon', {
    ...
    content: `<div style=" text-align: center;" sect="iconSector">
    <div sect="iconSector">
    <img sect="iconSector" sectid="icon-sec" src='data:image/svg+xml;base64,'/>
    </div>
    </div>
...
<li class="page-builder-list-item">
  ...
  addBlock('department', {
    ...
    content: ` <section  sect= "departmentSector">
    <div  sect= "departmentSector"  sectid="department-container" style="width: 70%;margin: auto;padding: 6rem margin-left: auto;margin-right: auto; text-align: center;">
      <div sect= "departmentSector" style="text-align: center;">
        <h1 sect= "departmentSector" sectid="main-department-heading" style=" margin-bottom: 0.5rem;">Departments</h1>
        <h2  sect= "departmentSector" sectid="sub-department-heading">The department module lists the departments as well as the job listings associated ,
            with the department, if applicable.
        </h2>
      </div>
      <div sect= "departmentSector" style="display: flex;" sectid="department-option" data-gjs-type="Departmentdiv" id="Departmentdiv">
